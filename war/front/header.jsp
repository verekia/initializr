...
<head>
	...
	<script type="text/javascript">
	  ...
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-11028046-9']);
...
<body>
	<div id="header-container">
		<header class="wrapper">
			...
			<h1 id="title"><a href="/">Initializr 2</a> <span style="font-size:24px">(beta - Pre H5BP 1.1)</span></h1>
...
<a href="https://github.com/verekia/initializr"><img
